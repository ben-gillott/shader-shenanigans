 ...
 */
void PhotonQueue::Photon::allocate(const int id, const Vec2 p, const Vec2 v) {
    pos = p;
    vel = v;
    age = 0;
    ship = id;
 ...
 */
void PhotonQueue::Photon::update() {
    pos += vel;
    age++;
 ...
 */
void PhotonQueue::Photon::destroy() {
    age = MAX_AGE+1;
}
 ...
 */
PhotonQueue::Photon* PhotonQueue::get(size_t pos) {
